...
input_folder = "/Users/bobby/PycharmProjects/lblm/src/animations/originals"
output_folder = "/Users/bobby/PycharmProjects/lblm/src/animations/GLBs"
...
already_converted = [tarfile.replace(".glb", "") for tarfile in os.listdir(output_folder) if tarfile.lower().endswith(".glb")]
